<div class="space-y-4">
    <div class="grid grid-cols-2 ">
        ...
        <div class="text-right flex gap-2 justify-end">
            <x-primary-button href="{{ route('transfer.pengiriman.index') }}" wire:navigate>
                Kembali
            </x-primary-button>
        </div>
    </div>
    ...
    $transfer->status_text }}</span></td>
                    ...
                    <tr>
                        <td class="font-semibold">Sudin Peminta</td>
                        <td>{{ $transfer->sudinPengirim?->name ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td class="font-semibold">Sudin Penerima (Anda)</td>
