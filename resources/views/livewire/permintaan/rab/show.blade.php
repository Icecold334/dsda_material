<div class="space-y-4">
    ...
    <livewire:components.request-information-modal :mode="'show'" :isRab="true" :key="'request-info-modal-show-rab'" />
    ...
    <div>
        <x-card title="Daftar Barang">
            <div data-grid data-api="{{ route('permintaan.rab.show.json', $permintaan) }}"
